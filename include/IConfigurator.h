...
class IConfigurator : public Generic
{
       public:
		 ...
		 */
        template <class T>
        bool GetProperty( const std::string& _type, const std::string& _name, const std::string& _attribute, T& _value ) const
        {
                return Get( _type, _name, _attribute, _value );
        }
       ...
       protected:
		 ...
		 */
        virtual bool Get( const std::string& _type, const std::string& _name, const std::string& _attribute, int& _value ) const
        {
                return false;
        }
		 ...
		 * @return True when property was found, Throws exception when not implemented
		 */
        virtual bool Get( const std::string& _type, const std::string& _name, const std::string& _attribute, std::string& _value ) const
        {
                return false;
        }
};
